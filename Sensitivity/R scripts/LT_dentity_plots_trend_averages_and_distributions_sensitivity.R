...
legend(x=25, y=(4/4*(b-a)+a), legend=expression(paste("+3.51% ",y^-1, sep = "")), bty="n", cex=1.3)
...
legend(x=25, y=(3.2/4*(b-a)+a), legend=expression(paste("+2.38% ",y^-1, sep = "")), bty="n", cex=1.3)
...
legend(x=25, y=(2.4/4*(b-a)+a), legend=expression(paste("-1.63% ",y^-1, sep = "")), bty="n", cex=1.3)
...
legend(x=16.8, y=(2.4/4*(b-a)+a), legend=expression(paste("+4.57% ",y^-1, sep = "")), bty="n", cex=1.3)
...
legend(x=16.8, y=(1.6/4*(b-a)+a), legend=expression(paste("+4.95% ",y^-1, sep = "")), bty="n", cex=1.3)
...
legend(x=16.8, y=(0.8/4*(b-a)+a), legend=expression(paste("+3.53% ",y^-1, sep = "")), bty="n", cex=1.3)
