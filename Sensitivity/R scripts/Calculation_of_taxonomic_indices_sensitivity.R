...
all_lf <- read.csv("Sensitivity/Data/LT_taxalist_2010-2020_long_sensitivity.csv", h = T, sep = ",", stringsAsFactors = FALSE, check.names=FALSE) ##this file is on OSF
head(all_lf)
...
####################################################
write.csv(TD_ALL, "Sensitivity/Outputs/LT_siteYr_TaxaDiversity_sensitivity.csv", row.names = FALSE)
####################################################
