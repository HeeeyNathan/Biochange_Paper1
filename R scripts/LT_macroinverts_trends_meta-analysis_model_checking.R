...
#### spp_richness ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_spp_richness.rds")
...
#### spp_rich_rare ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_spp_rich_rare.rds")
...
#### shannonsH ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_shannonsH.rds")
...
#### E10 ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_E10.rds")
...
#### abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_abundance.rds")
...
#### turnover ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_turnover.rds")
...
#### F_to ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_F_turnover.rds")
...
#### FRic ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FRic.rds")
...
#### FEve ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FEve.rds")
...
#### FDis ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FDis.rds")
...
#### FRic.SES ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FRic.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_FRic.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_FRic.SES.rds")

#prob of trend
fric.ses_prob <- getTrendProbability(fit)
fric.ses_prob <- data.frame(Response="FRic.SES", fric.ses_prob[,1:2])
fric.ses_prob

#check model
plot(fit)
fric.ses_loo <- loo(fit, cores = getOption("mc.cores", 1))
fric.ses_loo
fric.ses_parento <- as.list(pareto_k_table(fric.ses_loo))
Count_fric.ses <- rbind(fric.ses_parento[[1]],fric.ses_parento[[2]],fric.ses_parento[[3]],fric.ses_parento[[4]])
colnames(Count_fric.ses) <- "FRic.SES"
pp_check(fit, ndraws = 100)

#pull out fixed effects
fric.ses_fixed_995 <- fixef(fit, probs = c(0.005, 0.995))
fric.ses_fixed_975 <- fixef(fit, probs = c(0.025, 0.975))
fric.ses_fixed_95 <- fixef(fit, probs = c(0.05, 0.95))
fric.ses_fixed_90 <- fixef(fit, probs = c(0.1, 0.9))
fric.ses_fixed <- list(Response="FRic.SES", fric.ses_fixed_995[,1:4], fric.ses_fixed_975[,3:4],
                   fric.ses_fixed_95[,3:4],fric.ses_fixed_90[,3:4])
fric.ses_fixed <-data.frame(lapply(fric.ses_fixed, function(x) t(data.frame(x))))
fric.ses_fixed

#### FDis.SES ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FDis.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_FDis.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_FDis.SES.rds")

#prob of trend
fdis.ses_prob <- getTrendProbability(fit)
fdis.ses_prob <- data.frame(Response="FDis.SES", fdis.ses_prob[,1:2])
fdis.ses_prob

#check model
plot(fit)
fdis.ses_loo <- loo(fit, cores = getOption("mc.cores", 1))
fdis.ses_loo
fdis.ses_parento <- as.list(pareto_k_table(fdis.ses_loo))
Count_fdis.ses <- rbind(fdis.ses_parento[[1]],fdis.ses_parento[[2]],fdis.ses_parento[[3]],fdis.ses_parento[[4]])
colnames(Count_fdis.ses) <- "FDis.SES"
pp_check(fit, ndraws = 100)

#pull out fixed effects
fdis.ses_fixed_995 <- fixef(fit, probs = c(0.005, 0.995))
fdis.ses_fixed_975 <- fixef(fit, probs = c(0.025, 0.975))
fdis.ses_fixed_95 <- fixef(fit, probs = c(0.05, 0.95))
fdis.ses_fixed_90 <- fixef(fit, probs = c(0.1, 0.9))
fdis.ses_fixed <- list(Response="FDis.SES", fdis.ses_fixed_995[,1:4], fdis.ses_fixed_975[,3:4],
                       fdis.ses_fixed_95[,3:4],fdis.ses_fixed_90[,3:4])
fdis.ses_fixed <-data.frame(lapply(fdis.ses_fixed, function(x) t(data.frame(x))))
fdis.ses_fixed

#### FEve.SES ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FEve.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_FEve.SES.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_FEve.SES.rds")

#prob of trend
feve.ses_prob <- getTrendProbability(fit)
feve.ses_prob <- data.frame(Response="FEve.SES", feve.ses_prob[,1:2])
feve.ses_prob

#check model
plot(fit)
feve.ses_loo <- loo(fit, cores = getOption("mc.cores", 1))
feve.ses_loo
feve.ses_parento <- as.list(pareto_k_table(feve.ses_loo))
Count_feve.ses <- rbind(feve.ses_parento[[1]],feve.ses_parento[[2]],feve.ses_parento[[3]],feve.ses_parento[[4]])
colnames(Count_feve.ses) <- "FEve.SES"
pp_check(fit, ndraws = 100)

#pull out fixed effects
feve.ses_fixed_995 <- fixef(fit, probs = c(0.005, 0.995))
feve.ses_fixed_975 <- fixef(fit, probs = c(0.025, 0.975))
feve.ses_fixed_95 <- fixef(fit, probs = c(0.05, 0.95))
feve.ses_fixed_90 <- fixef(fit, probs = c(0.1, 0.9))
feve.ses_fixed <- list(Response="FEve.SES", feve.ses_fixed_995[,1:4], feve.ses_fixed_975[,3:4],
                       feve.ses_fixed_95[,3:4],feve.ses_fixed_90[,3:4])
feve.ses_fixed <-data.frame(lapply(feve.ses_fixed, function(x) t(data.frame(x))))
feve.ses_fixed

#### FRed ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_FRed.rds")
...
#### ept_spp_richness ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_ept_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_spp_richness.rds")
loo_R2(fit)
...
#### ept_abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_ept_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_abundance.rds")
...
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_diptera_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_spp_richness.rds")
loo_R2(fit)
...
#### diptera_abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_diptera_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_abundance.rds")
...
#### insect_richness ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_insect_spp_richness.rds")
...
#### insect_abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_insect_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_abundance.rds")
...
#### mollusc_richness ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_mollusc_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_richness.rds")
...
#### mollusc_abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_mollusc_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_abundance.rds")
...
#### annelid_richness ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_annelid_spp_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_richness.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_richness.rds")
...
#### annelid_abundance ####
fit <- readRDS("Outputs/Metaanalysis_trends/metaanalysis_noRandom_annelid_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Unweighted_wRandom/metaanalysis_unweighted_abundance.rds")
#fit <- readRDS("Outputs/Metaanalysis_trends/Weighted_wRandom/metaanalysis_abundance.rds")
...
Yr_metaanaly_Ests <- rbind(sr_fixed, srr_fixed, shH_fixed, e10_fixed, abund_fixed, turn_fixed, 
                           fto_fixed, fric_fixed, feve_fixed, fdis_fixed, fric.ses_fixed, fdis.ses_fixed, feve.ses_fixed, FRed_fixed,
...
Yr_metaanaly_probs <- rbind(sr_prob, srr_prob, shH_prob, e10_prob, ab_prob, turn_prob, 
                            fto_prob, fric_prob, feve_prob, fdis_prob, fric.ses_prob, fdis.ses_prob, feve.ses_prob, FRed_prob,
...
Yr_metaanaly_parento <- cbind(Count_sr, Count_srr, Count_shH, Count_e10, Count_ab, Count_turn, Count_fto,
                              Count_fric, Count_feve, Count_fdis, Count_fric.ses, Count_fdis.ses, Count_feve.ses, Count_FRed,
